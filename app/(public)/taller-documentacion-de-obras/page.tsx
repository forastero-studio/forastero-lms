...
export default async function TallerPage() {
  ...
  const access = userId
    ? (await hasAccess(userId, "taller-documentacion")) ||
    ...
    <main className="min-h-screen bg-paper">
      <div className="px-8 md:px-14 py-20 max-w-5xl mx-auto">
        ...
        <p className="text-xl font-light text-deep leading-relaxed max-w-2xl mb-4">
          Aprendés a dibujar planos ejecutivos profesionales con AutoCAD®. Más
          allá de las herramientas, es un método completo para documentar una
        ...
        <div className="grid md:grid-cols-2 gap-0 border border-line mb-16">
          <div className="bg-white p-8 border-b md:border-b-0 md:border-r border-line">
            ...
            <p className="text-sm font-light text-stone leading-relaxed">
              ...
              manejan AutoCAD® pero sienten que cada proyecto empieza de cero, y
              que el orden interno se sostiene con buena memoria en lugar de un
              sistema.
            </p>
          </div>
