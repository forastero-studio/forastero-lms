...
export function buildBienvenidaEmail(
  ...
  const bootcampHint = withBootcamp
    ? `<p style="font-size:14px;font-weight:300;line-height:1.6;margin:0 0 16px;color:#444;">Si compraste el Bootcamp, te recomiendo empezar por la Semana 1. El agente IA está disponible 24/7 desde tu dashboard.</p>`
    : "";
